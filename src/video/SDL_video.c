...
/*
 * Rotate 90 ccw 16 bitdepth
 */
static void rotate_90_ccw_16bpp(uint16_t* restrict dst, uint16_t* restrict src, int32_t w, int32_t h)
{
    src += w * h - 1;
...
/*
 * Rotate 90 ccw 32 bitdepth
 */
static void rotate_90_ccw_32bpp(uint32_t* restrict dst, uint32_t* restrict src, int32_t w, int32_t h)
{
    src += w * h - 1;
    for (int32_t col = w - 1; col >= 0; --col)
    {
